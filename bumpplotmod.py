...
def bumpchart(df, show_rank_axis=True, rank_axis_distance=1.1, 
    ...
    if show_rank_axis:
        ...
        # Added by me
        far_left = left_yaxis.twinx()
        axes.append(far_left)
    ...
    if show_rank_axis:
        ...
        # Added by me
        far_left.spines["left"].set_position(("axes", 1-rank_axis_distance))
        make_patch_spines_invisible(far_left)
        far_left.spines["left"].set_visible(True)
        far_left.yaxis.set_label_position('left')
        far_left.yaxis.set_ticks_position('left')
